...
As an analyst I love to document the requirements and decisions made and am happy to use One Note and Word. But it is definitely more fun to use Markdown, real data and html widgets to author an interactive playbook that also delights!
