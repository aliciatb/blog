...
Last month I took a few minutes to update my blog repo, [github.com/aliciatb/blog](https://github.com/aliciatb/blog) following  the steps outlined in this [article](https://www.techrepublic.com/article/github-to-replace-master-with-main-starting-in-october-what-developers-need-to-know/). Here's another great resource from R-bloggers of the [5 steps to change GitHub default branch from master to main](https://www.r-bloggers.com/2020/07/5-steps-to-change-github-default-branch-from-master-to-main/).
...
_Did I just copy and paste git code from the article? Yes, yes I did!_
...
## Technology changes are easy, let's not stop there!
